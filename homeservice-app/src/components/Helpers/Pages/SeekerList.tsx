...
//       const data = await res.json();
//       const seekerList = (data.users || []).filter(
//         (u: any) => u.role === "seeker"
//       );
...
//       {/* HEADER */}
//       <IonHeader>
//         <IonToolbar className="bg-purple-600 px-4 py-3">
...
//           <IonIcon icon={searchOutline} className="mr-2" />
//           <IonInput
//             placeholder="Search seekers..."
//             value={searchText}
//             onIonInput={(e: any) => setSearchText(e.target.value)}
...
//                 : "bg-white shadow"}`}
//           >
//             <IonIcon icon={appsOutline} className="text-xl mb-1" />
//             <p>All</p>
//           </div>
...
//             <div
//               key={seeker.account_id}
//               className={`p-3 rounded-xl mb-3 flex justify-between ${cardColors[index % cardColors.length]}`}
//               onClick={() => history.push(`/seeker/${seeker.account_id}`)}
//             >
//               <div className="flex gap-3">
//                 <IonAvatar>
//                   <img src={seeker.profile_picture || "https://i.pravatar.cc/150"} />
//                 </IonAvatar>

//                 <div>
//                   <p>{seeker.name}</p>
//                   <p className="text-sm">{seeker.phone}</p>
//                 </div>
//               </div>
