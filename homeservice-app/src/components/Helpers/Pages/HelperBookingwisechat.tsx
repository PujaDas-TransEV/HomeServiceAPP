...
//         if (profileRes.ok) {
//           const regId =
//             profileData.registration_id || profileData.profile?.registration;
//           setRegistrationId(regId);
//           console.log("Helper Registration ID:", regId);
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        if (res.ok) {
          const regId =
            data.registration_id || data.profile?.registration;
          setRegistrationId(regId);
              ...
              >
                ...
                {msg.file_url && (
                  <img
                    ...
                    className="w-24 h-24 mt-1 rounded"
                  />
                )}
