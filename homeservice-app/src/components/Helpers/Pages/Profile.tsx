...
useEffect(() => {
  ...
  const fetchProfileImage = async () => {
    try {
      const res = await fetch("http://192.168.0.187:9830/profiles/picture/base64", {
        method: "GET",
        headers: {
          ...
          <div className="flex items-center justify-between w-full">
            ...
            <IonButtons>
              <IonButton fill="clear" onClick={() => setOpenMenu(true)}>
                ...
                <div className="w-11 h-11 flex items-center justify-center bg-white/90 backdrop-blur-md rounded-full shadow-lg border border-pink-100">
  <IonIcon icon={menu} className="text-pink-600 text-2xl" />
</div>
              </IonButton>
            </IonButtons>
          </div>
      ...
      >
        ...
        <div className="p-4 space-y-4">
          {[
           ...
           {
  icon: peopleOutline,      // Ionicon
  label: "Seeker List / খোঁজকারী তালিকা",
  path: "/seeker-list",
