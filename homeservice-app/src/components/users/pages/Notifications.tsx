...
//   is_read: boolean;
//   created_at: string;
//   is_ws?: boolean; // 👈 identify websocket notification
// }
...
//       // ⚠️ Important: ensure API notifications are NOT marked as websocket
...
//           ...notification,
//           is_read: false, // ✅ force unread
//           is_ws: true, // ✅ mark as websocket
//           created_at:
//             notification.created_at || new Date().toISOString(),
//         };
...
//   const getBgClass = (n: Notification) => {
//     if (n.is_ws) {
//       return "bg-purple-200 dark:bg-purple-800"; // WebSocket
//     }
//     if (!n.is_read) {
//       return "bg-yellow-100 dark:bg-yellow-800"; // Unread
//     }
//     return "bg-gray-100 dark:bg-gray-700"; // Read
//   };
...
//               key={n.id}
//               onClick={() => !n.is_read && markAsRead(n.id)}
//               className={`mb-3 rounded-xl shadow-md cursor-pointer transition ${getBgClass(
//                 n
//               )}`}
//             >
//               <IonLabel>
